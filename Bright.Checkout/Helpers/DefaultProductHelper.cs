...
public static class DefaultProductHelper
{
    ...
    public static Dictionary<string, Product> GetDefaultProducts()
    {
        ...
        Dictionary<string, Product> defaultProducts =
            new()
            {
                {
                    defaultProductCodes[0],
                    new Product
                    {
                ...
                {
                    defaultProductCodes[2],
                    new Product { ProductCode = defaultProductCodes[2], StandardUnitPrice = 20 }
                },
                {
